...
from windiagkit.powershell_runner import run_powershell


class PowerShellRunnerTests(unittest.TestCase):
    @patch("windiagkit.powershell_runner.os_name", "nt")
    @patch("windiagkit.powershell_runner.run_visible", return_value=True)
    @patch("windiagkit.powershell_runner.load_script", return_value="script body")
    ...
    @patch("windiagkit.powershell_runner.load_script")
    ...
    @patch("windiagkit.powershell_runner.os_name", "nt")
    @patch(
        "windiagkit.powershell_runner.load_script",
